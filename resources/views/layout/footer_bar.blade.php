...
{{--                                       data-toggle="tab" href="#tab-events-header1">--}}
{{--                                        <span>Events</span>--}}
{{--                                    </a>--}}
{{--                                </li>--}}
{{--                                <li class="nav-item">--}}
{{--                                    <a role="tab" class="nav-link"--}}
{{--                                       data-toggle="tab" href="#tab-errors-header1">--}}
...
{{--                        </div>--}}
{{--                    </div>--}}
{{--                    <small>Copyright {{\Illuminate\Support\Carbon::now()->format('Y')}} © All Rights Reserved. <a--}}
{{--                            href="#">Commish.com</a></small>--}}
                </div>
            </div>
...
{{--                                        <div class="menu-header-image opacity-1"--}}
{{--                                             style="background-image: url('images/dropdown-header/city5.jpg');"></div>--}}
{{--                                        <div class="menu-header-content text-dark">--}}
