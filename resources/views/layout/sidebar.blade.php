    ...
    <ul class="side-menu">
        ...
        @if (
            ...
            <li
                ...
                request()->segment(2) == 'contactrole' ||
                request()->segment(2) == 'products' ||
                request()->segment(2) == 'industry' ||
                request()->segment(2) == 'lenders' ||
                request()->segment(2) == 'expensetype' ||
                request()->segment(2) == 'service' ||
                request()->segment(2) == 'referral' ||
                ...
                @if ($user_is_admin == 1 || in_array('reports', $module_permissions))
                    ...
                    <li>
                        <a href="{{ route('admin.fm_direct.index') }}"
                            class="slide-item {{ request()->segment(3) == 'fm-direct' ? 'mm-active' : '' }}">
                            <i class="metismenu-icon"></i>
                            Reports
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.lender.index') }}"
                            class="slide-item {{ request()->segment(3) == 'lender' ? 'mm-active' : '' }}">
                            <i class="metismenu-icon"></i>
                            Lender
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.referrors.index') }}"
                            class="slide-item {{ request()->segment(3) == 'referror' ? 'mm-active' : '' }}">
                            <i class="metismenu-icon"></i>
                            Referrer Invoices
                        </a>
                    </li>
