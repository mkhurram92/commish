<div class="app-header header-shadow">
    ...
    <div class="app-header__menu">
            <span>
                <button type="button"
                        class="btn-icon btn-icon-only btn btn-primary mobile-toggle-header-nav">
                    ...
                    <div tabindex="-1" role="menu" aria-hidden="true"
                        ...
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item-btn text-center nav-item">
                                <button class="btn-shadow btn btn-primary">Follow-ups</button>
                            </li>
                        </ul>
                    </div>
                </div>--}}
...
{{--                                                <button class="btn-wide btn btn-primary">Set Profile</button>--}}
{{--                                            </a>--}}
{{--                                        </li>--}}
{{--                                    </ul>--}}
{{--                                </div>--}}
...
{{--                            <button type="button" class="btn-shadow p-1 btn btn-primary show-toastr-example">--}}
