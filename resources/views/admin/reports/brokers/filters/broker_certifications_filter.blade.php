<form method="POST" id="aip_form" target="_blank">
    @csrf
...
@section('scripts')
    ...
    <script>
        ...
        $(".preview").on("click",function (){
            $("#aip_form").attr("action","{{ route("admin.fm_direct.get_approved_in_principle_records") }}");
            $("#aip_form").submit();
        });
        $(".export_pdf").on("click",function (){
            $("#aip_form").attr("action","{{ route("admin.fm_direct.export_approved_in_principle_records") }}");
            $("#aip_form").submit();
        });
    </script>
