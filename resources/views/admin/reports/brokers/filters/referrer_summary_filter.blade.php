<form method="POST" id="referrer_summary_form" target="_blank">
    @csrf
...
@section('scripts')
    ...
    <script>
        ...
        $(".preview").on("click",function (){
            $("#referrer_summary_form").attr("action","{{ route("admin.broker.preview_referrer_commission_summary") }}");
            $("#referrer_summary_form").submit();
        });
        $(".export_pdf").on("click",function (){
            $("#referrer_summary_form").attr("action","{{ route("admin.broker.export_referrer_commission_summary") }}");
            $("#referrer_summary_form").submit();
        });
    </script>
