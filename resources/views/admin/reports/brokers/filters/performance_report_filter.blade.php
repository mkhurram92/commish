<form method="POST" id="performance_records_form" target="_blank">
    @csrf
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-sm-12">
            <div class="form-group">
                <label for="lender_id" class="form-label">Lenders</label>
                <select class="form-control" name="lender_id" id="lender_id">
                    <option value=""></option>
...
@section('scripts')
    ...
    <script>
        ...
        $(".preview").on("click",function (){
            $("#performance_records_form").attr("action","{{ route("admin.broker.get_performance_records") }}");
            $("#performance_records_form").submit();
        });
        $(".export_pdf").on("click",function (){
            $("#performance_records_form").attr("action","{{ route("admin.broker.export_performance_records") }}");
            $("#performance_records_form").submit();
        });
    </script>
