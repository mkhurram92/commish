...
<head>
    <title>Lender Upfront not Received</title>
...
<table style="margin-top: 5px;margin-bottom:5px;width: 100%">
    <tbody>
    <tr>
        <td style="width: 25%"> <span style="font-size: 18px">Loans with Upfront but not received from lender</span></td>
    </tr>
    </tbody>
</table>
     ...
     <!--    <table class="row" style="margin-top: 5px;margin-bottom:5px;width: 100%">
        ...
        <table style="width: 100%;margin-top: 5px" >
            ...
            @foreach($lenders as $lender)
                    <?php
                    $deal_trail=\App\Models\DealCommission::where(['type'=>12, 'type'=>13])->where('deal_id',$lender->id)->orderBy('id','desc')->first();
                    ?>
                    @if(!$deal_trail)
