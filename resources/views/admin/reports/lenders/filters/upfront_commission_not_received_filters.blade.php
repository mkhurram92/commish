...
@section('scripts')
    ...
    <script>
        ...
        $(".preview").on("click",function (){
            $("#lender_form").attr("action","{{ route("admin.lender.get_upfront_commission_not_received") }}");
            $("#lender_form").submit();
        });
        $(".export_pdf").on("click",function (){
            $("#lender_form").attr("action","{{ route("admin.lender.export_trail_commission_not_received") }}");
            $("#lender_form").submit();
        });
    </script>
