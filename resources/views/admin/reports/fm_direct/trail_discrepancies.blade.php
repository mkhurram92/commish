...
<head>
    <title>Trail Discrepancies</title>
    <style>
        table {
            border: 0;
...
<table style="margin-top: 5px;margin-bottom:5px;width: 100%">
    <tbody>
    <tr>
        <td style="width: 25%"><span style="font-size: 18px;font-weight: bold;">FM Direct Trail Discrepancies</span>
        </td>
        <td><span
        ...
        <table style="width: 100%;margin-top: 5px">
            ...
            @foreach($deal as $comm)
                    ...
                    <tr>
                        ...
                        <td>${{ $comm['abp_trail'] }}</td>
                        <td>${{ $comm['receive_trail'] }}</td>
                    ...
                    $total_trail_amt+=$comm['abp_trail'];
                    $total_trail_received+=$comm['receive_trail'];
                    ?>
            @endforeach
            ...
            <tr>
                ...
                <th style="width: 4%"></th>
                <th style="width: 7%"></th>
                <th style="width: 7%">${{$total_trail_amt}}</th>
                <th style="width: 7%">${{$total_trail_received}}</th>
                <th style="width: 7%"></th>
                <th style="width: 7%"></th>
            </tr>
            </thead>
