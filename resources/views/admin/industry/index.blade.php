...
<div class="page-header">
    ...
    <div class="page-rightheader ml-auto d-lg-flex d-none">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">                             Industry
            </li>
        </ol>
    </div>
</div>
        ...
        <div class="col-sm-12">
            <div class="">
                <table style="width: 100%" id="TableData" class="table table-hover table-striped table-bordered"
                    ...
                    data-sAjaxSource="{{ route('admin.industry.getrecords') }}"
    ...
    $(document).ready(() => {
        ...
        function editRecord(current)
        {
            ...
            if(typeof id != "undefined" && parseInt(id) > 0)
            {
                showLoader();
                $.ajax({
                    url: "{{ route('admin.industry.getrecord') }}",
                    type:'POST',
                    data:  {
                        "_token": "{{ csrf_token() }}",
                        "id": id
            ...
            if(typeof id != "undefined" && parseInt(id) > 0)
            {
                ...
                swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('admin.industry.delete') }}",
                            type:'POST',
                            data:  {
                                "_token": "{{ csrf_token() }}",
                                "id": id
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Industry Type : Edit</h5>
        ...
        jQuery(document).ready(function(){
            $("#editForm").validate({
                ...
                submitHandler: function(){
                    ...
                    showLoader();
                    $.ajax({
                        url: "{{ route('admin.industry.update') }}",
                        type:'POST',
                        data:  {
                            "_token": "{{ csrf_token() }}",
