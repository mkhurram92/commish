...
<div class="app-page-title mb-0">
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            ...
            <div>
                Brokers Commissions :: {{$broker->given_name}}
            </div>
        </div>
        ...
        <div class="main-card mb-3 card">
            <div class="card-body">
                <h5 class="card-title float-right">
                    <a href="{{route('admin.brokercom.add', encrypt($broker->id))}}" class="btn btn-success">Add</a>
                </h5>
                ...
                <div class="table-responsive">
                    ...
                    <table style="width: 100%;max-width:none !important" id="TableData" class=" table-hover
                        ...
                        data-sAjaxSource="{{ route('admin.brokercom.getrecords',encrypt($broker->id)) }}"
            ...
            refreshdataTable(customArgs,function(response,fnCallback)
            {
                ...
                if(typeof response.payload != 'undefined')
                {
                    ...
                    if(payloads.aaData.length > 0 )
                    {
                        ...
                        {
                            var edit_row = '<a href="{{url('admin/broker-commissions/edit/')}}/'+value.encrypt_id+'/{{ encrypt
                            ($broker->id) }}" ' +
                                'data-id="'+value
                                    .id+'" ' +
                                'onclick="return' +
