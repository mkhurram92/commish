...
<div class="app-page-title mb-0">
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            ...
            <div>
                Brokers Tasks :: {{$broker->given_name}}
            </div>
        </div>
        ...
        <div class="main-card mb-3 card">
            <div class="card-body">
                <h5 class="card-title float-right">
                    <a href="{{route('admin.brokertsk.add', encrypt($broker->id))}}" class="btn btn-success">Add</a>
                </h5>
                ...
                <div class="table-responsive">
                    ...
                    <table style="width: 100%;max-width:none !important" id="TableData" class=" table-hover
                        ...
                        data-aoColumns='{"mData": "Index no"},{"mData": "Person to Followup"},{"mData": "Followup Date"}, {"mData": "Detail"},{"mData": "Completed Date"},{"mData": "Status"},{"mData": "Added On"},{"mData": "Modified On"},{"mData": "Action"}'>
                        <thead>
                            <tr>
                                <th>#</th>
            ...
            refreshdataTable(customArgs,function(response,fnCallback)
            {
                ...
                if(typeof response.payload != 'undefined')
                {
                    ...
                    if(payloads.aaData.length > 0 )
                    {
                        ...
                        {
                            var edit_row = '<a href="{{url('admin/broker-tasks/edit/')}}/'+value.encrypt_id+'/{{ encrypt
                            ($broker->id) }}" ' +
                                'data-id="'+value
                                    .id+'" ' +
                                'onclick="return' +
