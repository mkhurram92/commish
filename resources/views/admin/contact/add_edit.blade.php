...
@section('title')
    @if (isset($contact) && !empty($contact))
        @if ($contact->individual == 1)
            Edit Contact :: {{ $contact->surname }} {{ $contact->preferred_name }}
        @else
            Edit Company :: {{ $contact->trading }}
        @endif
    @else
        Add Client
    @endif
        ...
        <div class="page-rightheader d-lg-flex d-none ml-auto">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">
                    @if (isset($contact) && !empty($contact))
                        Edit Client :: {{ $contact->surname }} {{ $contact->preferred_name }}
                    @else
                        Add
                        @if (Route::current()->getName() == 'referrer_add')
                            Referrer
...
@section('body')
                                                        ...
                                                        <div class="col-md-4 col-sm-12" style="display:none;">
                                                            <div class="position-relative form-group">
                                                                ...
                                                                <select name="search_for" id="search_for" class="form-control"
                                                                    ...
                                                                    <option value="1"
                                                                        @if ((isset($contact) && $contact->search_for == '1') || Route::current()->getName() != 'referrer_add') selected @endif>
                                                                        Client
                                                                    </option>
                                                                    <option value="2"
                                                                        @if ((isset($contact) && $contact->search_for == '2') || Route::current()->getName() == 'referrer_add') selected @endif>
                                                                        Referror
                                                                    </option>
                                                                </select>
    ...
    @endif
                                                ...
                                                <div class="form-row">
                                                    <div class="col-md-4 col-sm-12" style="display:none;">
                                                        <div class="position-relative form-group">
                                                            <input type="hidden" name="search_for" value="1">
                                                            @if ($errors->has('search_for'))
                                                                <div class="error" style="color:red">
                                                                    {{ $errors->first('search_for') }}</div>
                                                            @endif
                                                ...
                                                <div class="form-row">
                                                    <div class="col-md-4 col-sm-4">
                                                        <div class="position-relative form-group">
                                                            <label class="form-label font-weight-bold">Client Type</label>
                                                                    ...
                                                                    <div class="position-relative form-group">
                                                                        ...
                                                                        <select name="client_referrals[{{ $rkey }}][service_id]" id="service_id_{{ $rkey }}"
                                                                            ...
                                                                            @foreach ($services as $service)
                                                                                <option value="{{$service->id}}" @if ($client_referral->service_id == $service->id) selected @endif>
                                                                                    {{$service->name}}
                                                                                </option>
                                                                            @endforeach
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        ...
                                                        <tbody id="task_tbody">
                                                                    ...
                                                                    <tr id="task_rw_{{ $tkey }}">
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <!--<input type="text"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               class="form-control alpha-num" id="tasks_{{ $tkey }}_processor"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               placeholder="Processor" maxlength="250"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               value="{{ $tval->processor }}"/>-->

                                                                            <select
                                                                                name="tasks[{{ $tkey }}][processor]"
                                                                                id="tasks_{{ $tkey }}_processor"
                                                                                class="multiselect-dropdown form-control">
                                                                                <option value="">Select Processor
                                                                                </option>
                                                                                @if (count($processors) > 0)
                                                                                    @foreach ($processors as $processor)
                                                                                        <option
                                                                                            value="{{ $processor->id }}"
                                                                                            {{ isset($tval) && $tval->processor == $processor->name ? 'selected="selected"' : '' }}>
                                                                                            {{ $processor->name }}
                                                                                        </option>
                                                                                    @endforeach
                                                                                @endif
                                                                        ...
                                                                        <td><input type="text"
                                                                                name="tasks[{{ $tkey }}][details]"
                                                                                class="form-control"
                                                                                id="tasks_{{ $tkey }}_details"
                                                            ...
                                                            @else
                                                                <tr id="task_rw_0">
                                                                    <td><input type="text" data-toggle="datepicker"
                                                                            placeholder="dd/mm/yyyy"
                                                                            name="tasks[0][followup_date]"
                                                                            class="task_followup_date form-control"
                                                                            id="tasks_0_follow_up_date"
                                                                            placeholder="Follow Up Date" /></td>
                                                                    <td><!--<input type="text" name="tasks[0][processor]"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           class="form-control alpha-num" id="tasks_0_processor"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           placeholder="Processor" maxlength="250"/>-->

                                                                        <select name="tasks[0][processor]"
                                                                            id="tasks_0_processor"
                                                                            class="multiselect-dropdown form-control">
                                                                            <option value="">Select Processor
                                                                            </option>
                                                                            @if (count($processors) > 0)
                                                                    ...
                                                                    <td><input type="text" name="tasks[0][details]"
                                                                            class="form-control" id="tasks_0_details"
                                                                            placeholder="Detail" maxlength="255" /></td>
...
@push('script-section')
    ...
    <script>
        ...
        jQuery(document).ready(function() {
            ...
            jQuery('body').on('change', '#street_type', function() {
                var selectedValue = jQuery(this).val();
                if (jQuery('#same_as_residential').is(':checked')) {
                    jQuery('#postal_street_type').val(selectedValue);
        ...
        var client_referral =
            {{ isset($client_referrals) && count($client_referrals) > 0 ? count($client_referrals) + 1 : 2 }};
        ...
        function addNewRelation(current) {
            var htmlCon = '<div class="col-sm-12" id="rel_' + rel_counter +
                ...
                'class="form-control relationship_' + rel_counter + '_relation"><option value="">Select Relation</option>' +
                relationstring +
                '</select></div></div><div class="col-sm-2"><button type="button" class="btn btn-danger" onclick="removerelation (this)" data-id="' +
        ...
        function addNewReferral(current) {
            ...
            htmlCon += '<select name="client_referrals[' + client_referral + '][service_id]" id="service_id_' +
                client_referral + '" class="form-control">';
            ...
            htmlCon += '<textarea name="client_referrals[' + client_referral + '][notes]" id="notes_' + client_referral +
                '" cols="30" rows="3"' +
                'placeholder="Note"' +
                'class="form-control w-100"></textarea>';
            htmlCon += '</div>';
            htmlCon += '</div>';
            htmlCon +=
                '<div class="col-sm-2"><button type="button" class="btn btn-danger" onclick="removeReferral (this)" data-id="' +
                client_referral + '"><i class="fa fa-trash"></i>';
        ...
        function addNewTask(current) {
            var task_tr = '<tr id="task_rw_' + task_counter +
                '"><td><input type="text"  autocomplete="off" placeholder="dd/mm/yyyy"  data-toggle="datepicker" name="tasks[' +
                task_counter +
                '][followup_date]" class="task_followup_date form-control" id="tasks_' + task_counter +
                '_follow_up_date" placeholder="Follow Up Date" /></td><td><select name="tasks[' + task_counter +
                '][processor]" id="tasks_' + task_counter +
                '_processor" class="multiselect-dropdown form-control"><option value="" >Select Processor</option>' +
                processorstring + '</select></td><td><input type="text" name="tasks[' + task_counter +
                '][details]" class=" form-control"id="tasks_' + task_counter +
                '_details"  placeholder="Detail" /></td><td><button class="btn btn-danger" onclick="return removetask(this)" data-id="' +
        ...
        function checkasresidentials(current) {
            if (jQuery(current).is(':checked')) {
                ...
                var currentStreetType = jQuery('#street_type').val();
                jQuery('#postal_street_type').val(currentStreetType);
                jQuery('#postal_street_type').select2({
                    placeholder: "Select Street type",
                });
                if (currentState != '') {
