        ...
        <div class="col-lg-12 col-md-12">
            ...
            <div class="main-card mb-3 card add_form_card">
                <div class="card-body">
                    ...
                    <div>
                        <form class="" id="" method="post" action="{{ route('admin.user.post') }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input name="image" id="image" placeholder="Upload Profile Image"
                                                    type="file">
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if ($.isEmptyObject(data.error)) {
                                ...
                                jQuery('#fname').val('').removeClass('is-invalid')
                                    .removeClass('is-valid');
                                jQuery('#lname').val('').removeClass('is-invalid')
                                    .removeClass('is-valid');
                                jQuery('#username').val('').removeClass('is-invalid')
                                    .removeClass('is-valid');
                                jQuery('#password').val('').removeClass('is-invalid')
                                    .removeClass('is-valid');
                                jQuery('#email').val('').removeClass('is-invalid')
                                    .removeClass('is-valid');
                                jQuery('#phone').val('').removeClass('is-invalid')
                                    .removeClass('is-valid');
                                hideLoader();
                                refreshTable();
                            } else {
...
@section('modal-section')
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">User :: Permissions</h5>
    ...
    <div class="modal fade edit-form-modal" tabindex="-1" role="dialog" aria-labelledby="Edit Form"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input name="fname" id="efname" placeholder="First Name" type="text"
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input name="lname" id="elname" placeholder="Last Name" type="text"
                                    class="form-control" required>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input name="phone" id="ephone" placeholder="Phone" type="text"
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input name="email" id="eemail" placeholder="Email" type="email"
                                    class="form-control" required>
                            </div>
                        </div>
                        <div class="col-sm-12">
                ...
                submitHandler: function() {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if ($.isEmptyObject(data.error)) {
                                successMessage(data.success);
                                jQuery('#efname').val('').removeClass('is-invalid')
                                    .removeClass('is-valid');
                                jQuery('#elname').val('').removeClass('is-invalid')
                                    .removeClass('is-valid');
                                jQuery('#eusername').val('').removeClass('is-invalid')
                                    .removeClass('is-valid');
                                jQuery('#eemail').val('').removeClass('is-invalid')
                                    .removeClass('is-valid');
                                jQuery('#epassword').val('').removeClass('is-invalid')
                                    .removeClass('is-valid');
                                jQuery('#ephone').val('').removeClass('is-invalid')
                                    .removeClass('is-valid');
                                jQuery('#edit_id').val('');
