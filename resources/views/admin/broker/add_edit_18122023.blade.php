...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="main-card mb-3 card">
            <div class="card-body">
                <form method="post" action="{{isset($broker)?route('admin.brokers.update', encrypt($broker->id)):route('admin.brokers.post')}}" onsubmit="return saveForm(this)">
                    @csrf
                    @if ($errors->any())
                                    ...
                                    <div class="card mb-2">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-4 col-sm-4">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <select name="broker_type" id="broker_type" class="form-control">
                                                            <option value="">Select Type</option>
                                                            <option value="Individual" @if (isset($broker) && $broker->individual == '1') selected @endif>
                                                                Individual
                                                            </option>
                                                            <option value="Company" @if (isset($broker) && $broker->individual == '2') selected @endif>
                                                                Company
                                                            </option>
                                                        </select>
                                                        @if ($errors->has('broker_type'))
                                                        <div class="error" style="color:red">
                                                            {{ $errors->first('broker_type') }}
                                                        </div>
                                                        @endif
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-4 col-sm-12 company-fields">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input name="entity_name" maxlength="255" value="{{isset($broker)?$broker->entity_name:""}}" placeholder="Company Name" type="text" class="form-control">
                                                ...
                                                <div class="col-md-4 col-sm-12 company-fields">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input name="trading" value="{{isset($broker)?$broker->trading:""}}" placeholder="Trading/Business" type="text" maxlength="255" class="form-control">
                                                ...
                                                <div class="col-md-4 col-sm-12 company-fields">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input name="trust_name" value="{{isset($broker)?$broker->trust_name:""}}" placeholder="Trust Name" maxlength="255" type="text" class="form-control">
                                            ...
                                            <div class="form-row">
                                                ...
                                                ?$broker->surname:""}}" placeholder="Surname" type="text" class="form-control">
                                                ...
                                                <div class="col-md-4 col-sm-12">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input name="preferred_name" maxlength="255" value="{{isset($broker)?$broker->given_name:""}}" placeholder="Given Name" type="text" class="form-control">
                                                ...
                                                <div class="col-md-4 col-sm-12">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input name="middle_name" maxlength="255" value="{{isset($broker)?$broker->middle_name:""}}" placeholder="Middle Name" type="text" class="form-control">
                                                ...
                                                <div class="col-md-4 col-sm-12">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input name="dob" value="{{isset($broker)?$broker->dob:""}}" type="text" placeholder="dd/mm/yyyy" data-toggle="datepicker" class="form-control">
                                                        @if($errors->has('dob'))
                                                ...
                                                <div class="col-md-4 col-sm-4">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <select name="is_active" id="is_active" class="form-control">
                                                            <option value="1" @if (isset($contact) && $contact->is_active == 1) selected @endif>
                                                                Active
                                                            </option>
                                                            <option value="0" @if (isset($contact) && $contact->is_active == 0) selected @endif>
                                                                In-Active
                                                            </option>
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="card-header">
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-md-4 col-sm-12">
                                                            <div class="position-relative form-group">
                                                                ...
                                                                <input name="work_phone" value="{{isset($broker)?$broker->work_phone:""}}" placeholder="Work Phone" type="text" class="form-control input_int_number" maxlength="15">
                                                        ...
                                                        <div class="col-md-4 col-sm-12">
                                                            <div class="position-relative form-group">
                                                                ...
                                                                <input name="home_phone" value="{{isset($broker)?$broker->home_phone:""}}" placeholder="Home Phone" type="text" class="form-control input_int_number" maxlength="15">
                                                        ...
                                                        <div class="col-md-4 col-sm-12">
                                                            <div class="position-relative form-group">
                                                                ...
                                                                <input name="mobile_phone" value="{{isset($broker)?$broker->mobile_phone:""}}" placeholder="Mobile Phone" type="text" class="form-control input_int_number" maxlength="15">
                                                ...
                                                <div class="col-md-4 col-sm-12">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input name="email" placeholder="Email" value="{{isset($broker)?$broker->email:""}}" type="email" class="form-control" maxlength="255">
                                                        @if($errors->has('email'))
                                                ...
                                                <div class="col-md-4 col-sm-12">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input name="web" placeholder="Web" value="{{isset($broker)?$broker->web:''}}" type="text" class="form-control" maxlength="255">
                                                        @if($errors->has('web'))
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input type="text" name="business" id="business" class="form-control" value="{{isset($broker)?$broker->business:""}}" />
                                                    </div>
                                                </div>
                                                <div class="col-md-4 col-sm-12">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <select name="state" id="state" class="multiselect-dropdown ">
                                                            ...
                                                            @if(count($states)>0)
                                                                ...
                                                                <option value="{{$state->id}}" {{isset($broker) && $broker->state == $state->id ? 'selected="selected"' : ''}}>
                                                                    {{$state->name}}
                                                                </option>
                                                                @endforeach
                                                            @endif
                                                ...
                                                <div class="col-md-4 col-sm-12">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input name="city" value="{{isset($broker)?$broker->city:""}}" placeholder="City" type="text" class="form-control alpha-num" maxlength="10">
                                                        @if($errors->has('city'))
                                                ...
                                                <div class="col-md-4 col-sm-12">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input name="postal_code" value="{{isset($broker)?$broker->pincode:""}}" placeholder="Postal Code" type="text" class="form-control alpha-num" maxlength="10">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-4 col-sm-12">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input type="text" placeholder="dd/mm/yyyy" data-toggle="datepicker" name="start_date" id="start_date" class="form-control
                                                ...
                                                <div class="col-md-4 col-sm-12">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input type="text" placeholder="dd/mm/yyyy" data-toggle="datepicker" name="end_date" id="end_date" class="form-control
                                                ...
                                                <div class="col-md-4 col-sm-12">
                                                    <div class="position-relative form-check form-check-inline">
                                                        ...
                                                        <label class="custom-switch" style="margin-top: 30px">
                                                            <input value="1" id="subject_to_gst" @if(isset($broker) && $broker->subject_to_gst == 1) checked
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-3 col-sm-12">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input type="text" name="bank" id="bank" class="form-control" placeholder="Bank Name" value="{{(isset($broker) && $broker->bank != '' ?
                                                       $broker->bank : '')}}" />
                                                    </div>
                                                </div>
                                                <div class="col-md-3 col-sm-12">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input type="text" name="acc_name" id="acc_name" class="form-control" placeholder="Account Name" value="{{(isset($broker) && $broker->account_name != '' ?
                                                       $broker->account_name : '')}}" />
                                                    </div>
                                                </div>
                                                <div class="col-md-3 col-sm-12">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input type="text" name="bsb" id="bsb" class="form-control" placeholder="BSB" value="{{(isset($broker) && $broker->bsb != '' ?
                                                       $broker->bsb : '')}}" />
                                                    </div>
                                                </div>
                                                <div class="col-md-3 col-sm-12">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input type="text" name="acc_number" id="acc_number" class="form-control input_int_number" placeholder="Account Number" value="{{(isset($broker) && $broker->account_number != '' ?
                                    ...
                                    <div class="card mb-2">
                                        ...
                                        <div class="card-body">
                                            <div class="form-row">
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="position-relative form-group">
                                                        <textarea name="note" id="note" cols="30" rows="5" placeholder="Note" class="form-control w-100">{{isset($broker)?$broker->note:""}}</textarea>
                                                        @if($errors->has('note'))
                                        ...
                                        <div class="card">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table">
                                                            ...
                                                            <tbody id="task_tbody">
                                                                ...
                                                                <tr id="task_rw_{{$tkey}}">
                                                                    <input type="hidden" name="referrors[{{$tkey}}][old_id]" id="referrors_{{$tkey}}_old_id" value="{{$tval->id}}" />
                                                                    <td><select name="referrors[{{$tkey}}][referror]" id="referrors_{{$tkey}}_referror" class="form-control">
                                                                            <option value=""></option>
                                                                    ...
                                                                    <td><input type="text" name="referrors[{{$tkey}}][upfront]" class="
                                                            form-control number-input" data-min="0" data-max="100" id="referrors_{{$tkey}}_upfront" placeholder="Upfront" maxlength="255" value="{{$tval->upfront}}" /></td>
                                                                    <td><input type="text" name="referrors[{{$tkey}}][trail]" class="
                                                            form-control number-input" id="referrors_{{$tkey}}_trail" placeholder="Trail" maxlength="255" value="{{$tval->trail}}" /></td>
                                                                    <td><input type="text" name="referrors[{{$tkey}}][comm_per_deal]" class=" form-control number-input" data-min="0" data-max="100" id="referrors_{{$tkey}}_comm_per_deal" placeholder="Comm per deal" value="{{$tval->comm_per_deal}}" /></td>
                                                                    <td>
                                                                        <button class="btn btn-danger" onclick="return removeReferror(this)" data-id="{{$tkey}}"><i class="fa fa-trash"></i></button>
                                                                    </td>
                                                                </tr>
                                                                @endforeach
                                                                @else
                                                                <tr id="task_rw_0">
                                                                    <td><select name="referrors[0][referror]" id="referrors_0_referror" class="form-control referrors_sel_cl">
                                                                            <option value=""></option>
                                                                            @foreach($refferors as $refferor)
                                                            ...
                                                            form-control number-input" data-min="0" data-max="100" id="referrors_0_upfront" placeholder="Upfront" maxlength="255" /></td>
                                                                    <td><input type="text" name="referrors[0][trail]" class="
                                                            form-control number-input" id="referrors_0_trail" placeholder="Trail" maxlength="255" /></td>
                                                                    <td><input type="text" name="referrors[0][comm_per_deal]" class=" form-control number-input" data-min="0" data-max="100" id="referrors_0_comm_per_deal" placeholder="Comm per deal" /></td>
                                                                    <td></td>
                                                                </tr>
                                            ...
                                            <div class="col-sm-12 mb-5">
                                                <div class="float-right">
                                                    <button type="button" class="btn btn-primary" id="add_new_referror" onclick="addNewReferror(this)">Add new Referror
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    ...
    //var task_counter = {
    //    {
    //        isset($broker, $broker -> referrors) && count($broker -> referrors) > 0 ? count($broker -> referrors) : 2
    //    }
    //};
...
<script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var clientTypeDropdown = document.getElementById('broker_type');
            ...
            if (clientTypeDropdown && companyFieldsInputs.length > 0) {
