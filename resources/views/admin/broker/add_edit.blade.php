                    ...
                    <form method="post"
                                            ...
                                            <div class="card-body">
                                                <div class="form-row">
                                                    <div class="col-md-6 col-sm-12">
                                                        <div class="position-relative form-group" id="parent"
                                                            style="display: none;">
                                                            <label class="form-label font-weight-bold">Parent Broker</label>
                                                            <select name="parent_broker" id="parent_broker"
                                                                class="form-control">
                                                                <option selected value="">Choose Parent Broker
                                                                </option>
                                                                @foreach ($parents as $parent)
                                                                    <option value="{{ $parent->id }}"
                                                                        {{ isset($broker) && $broker->parent_broker == $parent->id ? 'selected="selected"' : '' }}>
                                                        ...
                                                        <div class="position-relative form-group">
                                                            ...
                                                            <select name="individual" id="individual" class="form-control">
                                                                ...
                                                                <option value="Individual"
                                                                    @if (isset($broker) && $broker->is_individual == '1') selected @endif>
                                                                    Individual
                                                                </option>
                                                                <option value="Company"
                                                                    @if (isset($broker) && $broker->is_individual == '2') selected @endif>
                                                                    Company
                                                                </option>
                                                            </select>
                                                    ...
                                                    <div class="col-md-4 col-sm-12 company-fields">
                                                        <div class="position-relative form-group">
                                                            <label class="form-label font-weight-bold">Trading/Business
                                                                Name</label>
                                                            <input name="trading"
                                                                value="{{ isset($broker) ? $broker->trading : '' }}"
                                                    ...
                                                    <div class="col-md-4 col-sm-12 company-fields">
                                                        <div class="position-relative form-group">
                                                            ...
                                                            <input name="trust_name"
                                                                value="{{ isset($broker) ? $broker->trust_name : '' }}"
                                                    ...
                                                    <div class="col-md-4 col-sm-4">
                                                        <div class="position-relative form-group">
                                                            ...
                                                            <select name="role_title" id="role_title"
                                                                class="form-control">
                                                                <option value="Mr"
                                                                    @if (isset($broker) && $broker->role_title == 'mr') selected @endif>
                                                                    Mr
                                                                </option>
                                                                <option value="Miss"
                                                                    @if (isset($broker) && $broker->role_title == 'miss') selected @endif>
                                                                    Miss
                                                                </option>
                                                                <option value="Mrs"
                                                                    @if (isset($broker) && $broker->role_title == 'mrs') selected @endif>
                                                                    Mrs
                                                                </option>
                                                                <option value="Ms"
                                                                    @if (isset($broker) && $broker->role_title == 'ms') selected @endif>
                                                                    Ms
                                                                </option>
                                                                <option value="Dr"
                                                                    @if (isset($broker) && $broker->role_title == 'dr') selected @endif>
                                                                    Dr
                                                                </option>
                                                                <option value="Prof"
                                                                    @if (isset($broker) && $broker->role_title == 'prof') selected @endif>
                                                                    Prof.
                                                                </option>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="col-md-4 col-sm-12">
                                                        <div class="position-relative form-group">
                                                            ...
                                                            <input name="surname" maxlength="150"
                                                                value="{{ isset($broker) ? $broker->surname : '' }}"
                                                    ...
                                                    <div class="col-md-4 col-sm-4">
                                                        <div class="position-relative form-group">
                                                            ...
                                                            <select name="is_active" id="is_active" class="form-control">
                                                                <option value="1"
                                                                    @if (isset($broker) && $broker->is_active == 1) selected @endif>
                                                                    Active
                                                                </option>
                                                                <option value="0"
                                                                    @if (isset($broker) && $broker->is_active == 0) selected @endif>
                                                                    Inactive
                                                                </option>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="col-md-4 col-sm-12">
                                                        <div class="position-relative form-group">
                                                            ...
                                                            <input name="work_phone"
                                                                value="{{ isset($broker) ? $broker->work_phone : '' }}"
                                                    ...
                                                    <div class="col-md-4 col-sm-12">
                                                        <div class="position-relative form-group">
                                                            ...
                                                            <input name="home_phone"
                                                                value="{{ isset($broker) ? $broker->home_phone : '' }}"
                                                    ...
                                                    <div class="col-md-4 col-sm-12">
                                                        <div class="position-relative form-group">
                                                            ...
                                                            <input name="email" placeholder="Email"
                                                                value="{{ isset($broker) ? $broker->email : '' }}"
                                            ...
                                            <div class="card-body">
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-8 col-sm-12">
                                                        <div class="position-relative form-group">
                                                            <label class="form-label font-weight-bold">Street name</label>
                                                    ...
                                                    <div class="col-md-4 col-sm-12">
                                                        <div class="position-relative form-group">
                                                            ...
                                                            <input name="city"
                                                                value="{{ isset($broker) ? $broker->city : '' }}"
                                                                placeholder="City" type="text"
                                                                class="form-control alpha-num">
                                                            @if ($errors->has('city'))
                                                                <div class="error" style="color:red">
                                                                ...
                                                                @if (count($states) > 0)
                                                                    @foreach ($states as $state)
                                                                        <option value="{{ $state->id }}"
                                                                            {{ isset($broker) && $broker->state == $state->id ? 'selected="selected"' : '' }}>
                                                                            {{ $state->name }}
                                                                        </option>
                                                                    @endforeach
                                                                @endif
                                                    ...
                                                    <div class="col-md-4 col-sm-12">
                                                        <div class="position-relative form-group">
                                                            ...
                                                            <input name="postal_code"
                                                                value="{{ isset($broker) ? $broker->pincode : '' }}"
                                                ...
                                                <div class="form-row">
                                                    <div class="col-md-3 col-sm-12">
                                                        <div class="position-relative form-group">
                                                            ...
                                                            <input type="text" name="abn" id="abn"
                                                                class="form-control alpha-num"
                                                                value="{{ isset($broker) && $broker->abn != '' ? $broker->abn : '' }}"
                                                                maxlength="250">

                                                            @if ($errors->has('abn'))
                                                                <div class="error" style="color:red">
                                                                    {{ $errors->first('abn') }}</div>
                                                            @endif
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 col-sm-12">
                                                        <div class="position-relative form-group">
                                                            ...
                                                            <input type="text" placeholder="dd/mm/yyyy"
                                                                ...
                                                                id="start_date"
                                                                class="form-control"
                                                                value="{{ isset($broker) && $broker->start_date != '' ? $broker->start_date : '' }}"
                                                                maxlength="15">
                                                    ...
                                                    <div class="col-md-3 col-sm-12">
                                                        <div class="position-relative form-group">
                                                            ...
                                                            <input type="text" placeholder="dd/mm/yyyy"
                                                                data-toggle="datepicker" name="end_date" id="end_date"
                                                                class="form-control"
                                                                value="{{ isset($broker) && $broker->end_date != '' ? $broker->end_date : '' }}"
                                                                maxlength="15">
                                                    ...
                                                    <div class="col-md-3 col-sm-12">
                                                        <div class="position-relative form-group">
                                                            <label class="form-label font-weight-bold">Subject to
                                                                GST</label>
                                                            <select name="subject_to_gst" id="subject_to_gst"
                                                                class="form-control">
                                                                <option value="1"
                                                                    @if (isset($broker) && $broker->subject_to_gst == 1) selected @endif>
                                                                    Yes
                                                                </option>
                                                                <option value="0"
                                                                    @if (isset($broker) && $broker->subject_to_gst == 0) selected @endif>
                                                                    No
                                                                </option>
                                                            </select>
                                                        </div>
                                                ...
                                                <div class="col-sm-12 mb-5">
                                                    <div class="float-right">
                                                        <button type="button" class="btn btn-primary"
                                                            id="add_new_referror" onclick="addNewReferror(this)">Add new
                                                            Referror
                                                        </button>
                                                    </div>
                                                </div>
                        ...
                        <div class="clearfix">
                            ...
                            <button type="submit" id="finish-btn"
                                class="btn-shadow float-right btn-wide btn-pill mr-3 btn btn-success">Finish</button>
