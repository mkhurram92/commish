        ...
        <div class="main-card mb-3 card">
            <div class="card-body">
                <h5 class="card-title float-right">
                    <a href="{{route('admin.dealtsk.add', encrypt($deal->id))}}" class="btn btn-success">Add</a>
                </h5>
                ...
                <div class="table-responsive">
                    ...
                    <table style="width: 100%;max-width:none !important" id="TableData" class=" table-hover
                        ...
                        data-aoColumns='{"mData": "Index no"},{"mData": "Followup Date"},{"mData": "Processor"},
                        {"mData": "User"},{"mData": "Detail"},{"mData": "Note"},{"mData": "Added On"},{"mData":
                        "Action"}'>
                        <thead>
                            <tr>
                                <th>#</th>
            ...
            refreshdataTable(customArgs,function(response,fnCallback)
            {
                ...
                if(typeof response.payload != 'undefined')
                {
                    ...
                    if(payloads.aaData.length > 0 )
                    {
                        ...
                        {
                            var edit_row = '<a href="{{url('admin/deals-tasks/edit/')}}/'+value.encrypt_id+'/{{ encrypt
                            ($deal->id) }}" ' +
                                'data-id="'+value
                                    .id+'" ' +
                                'onclick="return' +
