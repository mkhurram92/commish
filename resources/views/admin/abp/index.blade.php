                ...
                <form class="form-inline" id="addForm" method="post" action="">
                    <div class="col-sm-4">
                        <div class="mb-2 mr-sm-2 mb-sm-0 position-relative form-group">
                            <label for="name" class="mr-sm-2 font-weight-bold">Name</label>
                            <input name="name" maxlength="255"  id="name" placeholder="" type="text"
                                   class="form-control">
                        </div>
                    </div>
        ...
        <div class="card-body">
           <div class="col-sm-12">
               <div class="">
                   ...
                   <table style="width: 100%;" id="TableData" class="table table-hover table-striped table-bordered" data-sAjaxSource="{{ route('admin.abp.getrecords') }}"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">ABP :: Edit</h5>
