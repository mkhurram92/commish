    ...
    <div class="page-header">
        ...
        <div class="page-rightheader ml-auto d-lg-flex d-none">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">                             Loan Types
                </li>
            </ol>
        </div>
    </div>
           ...
           <div class="col-sm-12">
               <div class="">
                   <table style="width: 100%"  id="TableData" class="table table-hover table-striped table-bordered"
                           data-toggle="table" data-height="500" data-show-columns="true" data-sAjaxSource="{{ route('admin.loantype.getrecords') }}"
    ...
    <script>
        $(document).ready(() => {
            $("#addForm").validate({
                ...
                submitHandler: function(){
                    ...
                    $.ajax({
                        url: "{{ route('admin.loantype.savedata') }}",
                        type:'POST',
                        data:  {
                        "_token": "{{ csrf_token() }}",
        ...
        function editRecord(current)
        {
            ...
            if(typeof id != "undefined" && parseInt(id) > 0)
            {
                showLoader();
                $.ajax({
                    url: "{{ route('admin.loantype.getrecord') }}",
                    type:'POST',
                    data:  {
                        "_token": "{{ csrf_token() }}",
                        "id": id
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Loan Type :: Edit</h5>
        ...
        jQuery(document).ready(function(){
            $("#editForm").validate({
                ...
                submitHandler: function(){
                    ...
                    showLoader();
                    $.ajax({
                        url: "{{ route('admin.loantype.update') }}",
                        type:'POST',
                        data:  {
                            "_token": "{{ csrf_token() }}",
