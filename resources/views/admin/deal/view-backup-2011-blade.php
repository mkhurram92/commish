        ...
        <div class="page-leftheader">
            <h4 class="page-title">
                ...
                btn-primary text-white"
                    href="{{ route('admin.deals.edit', encrypt($deal->id)) }}"><i
                        class="pe-7s-pen
        ...
        <div class="tab-menu-heading">
            <div class="tabs-menu ">
                <ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav panel-tabs">
                    ...
                    <li class="ml-auto">
                        <button class="btn btn-primary" onclick="window.alert('this lead has been archived')">Archive this lead</button>
                    </li>
                </ul>
            </div>
        </div>
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        <p class="mb-2"><b>Broker : </b>
                                                            <a class="active_a" href="{{ route('admin.brokers.view', encrypt($deal->broker_id)) }}" target="_blank">{{ $deal->broker_display_name }}</a>
                                                        </p>
                                                        <p class="mb-2"><b>Broker Staff :
                                                            </b>{{ $deal->broker_staff_display_name }}</p>
                                                        <p class="mb-2"><b>Client : </b><a class="active_a" href="{{ route('admin.contact.edit', encrypt($deal->contact_id)) }}">{{ $deal->fullname }}</a></p>
                                                        <p class="mb-2"><b>Product : </b>{{ $deal->productname }}</p>
                                                        <p class="mb-2"><b>Lender : </b>{{ $deal->lendername }}</p>
                                                        <p class="mb-2"><b>loan type : </b>{{ $deal->withLoanType->name }}</p>
                                                        <p class="mb-2"><b>GST Applies : </b>{{ $deal->gst_applies=="1"?"Yes":"No" }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-3 d-flex align-items-stretch">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @if ($deal->linkto_pk_id)
                                                            <p class="mb-2"><b>Linked To : </b> <a
                                                                    ...
                                                                    class="active_a">{{ $deal->linkto_pk_id }}-{{ $deal->linked_to_display_name }}</a>
                                                            </p>
                                                        @endif
                                                        ...
                                                        <p class="mb-2"><b>Proposed Settlement :
                                                            </b>{{ date('d/m/Y', strtotime($deal->proposed_settlement)) }}
                                                        </p>
                                                ...
                                                <table>
                                                    @forelse ($deal->withNotes as $index => $note)
                                                        <tr class="{{ $index%2==0?" bg-light ":"" }}">
                                                            ...
                                                            <td style="width:80%">{{ $note->note }}</td>
                                                            <td style="width:15%">
                                                                <a href="javascript:void(0)" class="btn btn-primary edit-note" data-href="{{ route("admin.deals.editNote",['note_id'=>encrypt($note->id)]) }}">
                                                                    Edit
                                                                </a>
                                                                <a href="javascript:void(0)" class="btn btn-primary delete-note" data-href="{{ route("admin.deals.deleteNote",['note_id'=>encrypt($note->id)]) }}">
                                                                    Delete
                                                                </a>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    {{-- @forelse ($deal->withNotes as $index => $note)
                                                        <div class="col-md-12 p-2 d-flex">
                                                            <p class="mx-3 mb-0">
                                                                ...
                                                                <strong>
                                                                    --
                                                                    <a href="javascript:void(0)" class="edit-note" data-href="{{ route("admin.deals.editNote",['note_id'=>encrypt($note->id)]) }}">
                                                                        Edit
                                                                    </a>
                                                                    /
                                                                    <a href="javascript:void(0)" class="delete-note" data-href="{{ route("admin.deals.deleteNote",['note_id'=>encrypt($note->id)]) }}">
                                                                        Delete
                                                                    </a>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header d-flex justify-content-between">
                                        ...
                                        <div class="add-btn">
                                            <button class="btn btn-primary add-relation" data-href="{{ route("admin.deals.addRelation",['deal_id'=>encrypt($deal->id)]) }}">Add Relation</button>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="col-sm-12">
                                            <div class="table-responsive">
                                                <table class="table table-bordered" id="relationship-table">
                                                    <thead>
                                                        <tr>
                                                            <th>No.</th>
                                                            <th>Name</th>
                                                        ...
                                                        @if (count($deal->relationDetails) > 0)
                                                            @foreach ($deal->relationDetails as $ke => $relationDetail)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="javascript:void(0)" class="btn btn-sm btn-primary edit-relation" data-href="{{ route("admin.deals.editRelation",['relationship'=>encrypt($relationDetail->deal_clients_rel_id)]) }}">Edit</a>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                        @endif
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="col-sm-12">
                                            <div class="table-responsive">
                                                <table class="table table-bordered" id="upfront_table">
                                                    <thead>
                                                        <tr>
                                                            <th>
                                                                Type
            ...
            $(document).on("click", ".editTrail,.editTrail .pe-7s-pen", function(e) {
                ...
                if (url) {
                    $.get(url, function(data) {
                        ...
                        $("#trail-modal").find(".commission_type:first").val(data?.data?.commission_type_id).trigger("change");
                        $("#trail-modal").find(".total_amount:first").val(data?.data?.total_amount);
                        $("#trail-modal").find("#bro_amt_date_paid_1").val(data?.data?.bro_amt_date_paid);
                        $("#trail-modal").find("#ref_amt_date_paid_1").val(data?.data?.ref_amt_date_paid);
                        $("#trail-modal").find(".date_statement:first").val(moment(data?.data?.date_statement,"DD-MM-YYYY").format('YYYY-MM-DD'));
                        $("#trail-modal").find(".agg_amount:first").val(data?.data?.agg_amount);
                        $("#trail-modal").find(".broker_amount:first").val(data?.data?.broker_amount);
                        $("#trail-modal").find(".referror_amount:first").val(data?.data?.referror_amount);
                    })
                }
            })
                ...
                success: function(data) {
                    ...
                    if (!$.isEmptyObject(data.error)) {
                        ...
                        if (typeof data.deal != "undefined" && data.deal != '') {
                            ...
                            jQuery('#add_task_form').attr('action', '{{ url('admin/deals-tasks/update') }}/' +dealtaskdata.enc_id + '/{{ encrypt($deal->id) }}')
...
@section('modal-section')
    ...
    <div class="modal fade add-note-modal" id="add-note-modal" tabindex="-1" role="dialog" aria-labelledby="Deal Tasks" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{ route("admin.deals.addNote",['deal_id'=>encrypt($deal->id)]) }}" onsubmit="return saveNoteForm(this)" id="add_note_form">
                        @csrf
                        <div class="form-row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group ">
                                        ...
                                        <input type="date" placeholder="mm/dd/yyyy" name="date_statement_1" id="date_statement_1" class="form-control " maxlength="13" />
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group ">
                                        <label class="mr-sm-2 font-weight-bold">Commish Amount</label>
                                        <input type="text" name="agg_amount_1" placeholder="Agg Amount" id="agg_amount_1" class="form-control number-input" maxlength="13" />
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" placeholder="mm/dd/yyyy" name="bro_amt_date_paid_1" id="bro_amt_date_paid_1" class="form-control " />
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label class="mr-sm-2 font-weight-bold">Referrer Amount</label>
                                        <input type="text" name="referror_amount_1" value="0" placeholder="Referrer Amount" id="referror_amount_1" class="form-control number-input" maxlength="13" />
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label class="mr-sm-2 font-weight-bold">Date Paid</label>
                                        <input type="date" placeholder="mm/dd/yyyy" name="ref_amt_date_paid_1" id="ref_amt_date_paid_1" class="form-control " />
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <button class="mt-1 btn btn-primary">Submit</button>
    ...
    <div class="modal fade trail-modal" id="trail-modal" tabindex="-1" role="dialog" aria-labelledby="Deal Trail"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('admin.deals.updatecomdata') }}" onsubmit="return saveTrailForm(this)" id="add_trail_form">
                        @csrf
                        <div class="form-row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <label class="mr-sm-2 font-weight-bold">Broker Amount</label>
                                        <input type="text" name="broker_amount" placeholder="Broker Amount" class="form-control number-input broker_amount" maxlength="13" />
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
