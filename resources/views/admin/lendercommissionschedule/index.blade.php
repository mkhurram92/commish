...
<div class="page-header">
    ...
    <div class="page-rightheader ml-auto d-lg-flex d-none">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">                             Lender::commission Schedule
            </li>
        </ol>
    </div>
</div>
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="mb-2 mr-sm-2 mb-sm-0 position-relative form-group">
                                <label for="lender_id" class="mr-sm-2">Lender</label>
        ...
        <div class="col-sm-12">
            <div class="">
                <table style="width: 100%" id="TableData" class="table table-hover table-striped table-bordered"
                    ...
                    data-sAjaxSource="{{ route('admin.lendercommissionschedule.getrecords') }}"
                    data-aoColumns='{"mData": "Index no"},{"mData": "Lender"},{"mData": "Product"},{"mData": "Commis Type"},{"mData": "Flat Rate"},{"mData": "Per Rate"},{"mData": "Modified On"},{"mData": "Action"}'>
                    <thead>
                        <tr>
                            <th class="no-sort">#</th>
                            <th class="noVis">Lender</th>
                            <th class="noVis">Product</th>
                            <th class="noVis">Commis. Type</th>
                            <th class="noVis">Flat Rate</th>
                            <th class="noVis">% Rate</th>
                            <th class="noVis">Modified On</th>
    ...
    $(document).ready(() => {
        ...
        jQuery('#commission_type_id').val('').select2({
            ...
            $("#addForm").validate({
                ...
                submitHandler: function(){
                    ...
                    $.ajax({
                        url: "{{ route('admin.lendercommissionschedule.post') }}",
                        type:'POST',
                        data:  {
                        "_token": "{{ csrf_token() }}",
        ...
        function editRecord(current)
        {
            ...
            if(typeof id != "undefined" && parseInt(id) > 0)
            {
                showLoader();
                $.ajax({
                    url: "{{ route('admin.lendercommissionschedule.getrecord') }}",
                    type:'POST',
                    data:  {
                        "_token": "{{ csrf_token() }}",
                        "id": id
                    ...
                    success: function(data) {
                        ...
                        if($.isEmptyObject(data.error)){
                            ...
                            {
                                jQuery('#edit_lender_id').val(payloadData.lender_id).select2({
            ...
            if(typeof id != "undefined" && parseInt(id) > 0)
            {
                ...
                swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('admin.lendercommissionschedule.delete') }}",
                            type:'POST',
                            data:  {
                                "_token": "{{ csrf_token() }}",
                                "id": id
