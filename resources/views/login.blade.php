                            ...
                            <div class="col-lg-9 col-xl-8">
                                <div class="card-group mb-0">
                                    ...
                                    <div class="card p-4 page-content">
                                        <div class="card-body page-single-content p-5"
                                            ...
                                            <div class="w-100">
                                               ...
                                               <img src="{{ url('assets/images/logo-commish.png') }}" class="header-brand-img desktop-lgo" alt="Commish  logo">
                                                ...
                                                @if ($message = Session::get('success'))
                                                    <div class="alert notify-popup alert-success mb-2"
                                                        id="alert-success-message" role="alert">
                                                        <strong>Success! </strong> {{ $message }}
                                                    </div>
                                                @endif
                                                @if ($message = Session::get('error'))
                                                    <div class="alert notify-popup alert-danger mb-2"
                                                        id="alert-error-message" role="alert">
                                                ...
                                                <form method="post" action="{{ route('auth.login') }}">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input name="username" id="exampleEmail" required
                                                            placeholder="Username here..." type="text"
                                                            class="form-control">
                                                    ...
                                                    <div class="input-group mb-4">
                                                        <span class="input-group-addon">
                                                            <svg class="svg-icon" version="1.1"
                                                                ...
                                                                <path
                                                                    d="M14 2.5c0 0.828-2.686 1.5-6 1.5s-6-0.672-6-1.5c0-0.828 2.686-1.5 6-1.5s6 0.672 6 1.5z">
                                                                </path>
                                                                <path
                                                                    d="M8 5c-3.3 0-6-0.7-6-1.5v3c0 0.8 2.7 1.5 6 1.5s6-0.7 6-1.5v-3c0 0.8-2.7 1.5-6 1.5z">
                                                                </path>
                                                                <path
                                                                    d="M8 9c-3.3 0-6-0.7-6-1.5v3c0 0.8 2.7 1.5 6 1.5s6-0.7 6-1.5v-3c0 0.8-2.7 1.5-6 1.5z">
                                                                </path>
                                                                <path
                                                                    d="M8 13c-3.3 0-6-0.7-6-1.5v3c0 0.8 2.7 1.5 6 1.5s6-0.7 6-1.5v-3c0 0.8-2.7 1.5-6 1.5z">
                                                                </path>
                                                            </svg>
                                                        </span>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <button type="submit"
                                                                class="btn btn-lg btn-primary btn-block"><i
